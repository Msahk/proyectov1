...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-10-2025 a las 05:20:43
...
(3, 'Azúcar', 40.00, 'kg', 25.00, -10.00, NULL, 'Activo'),
...
(66, '2025-10-17', 'Completada', 0, '2025-10-11 12:18:17'),
(67, '2025-10-10', 'Pendiente', 0, '2025-10-11 13:02:42'),
(68, '2025-10-13', 'Pendiente', 1, '2025-10-13 18:54:22'),
(69, '2025-10-13', 'Pendiente', 1, '2025-10-13 18:57:02'),
(70, '2025-10-13', 'Pendiente', 1, '2025-10-13 21:16:02'),
(71, '2025-10-13', 'Completada', 14, '2025-10-13 22:04:57');
...
--
ALTER TABLE `produccion`
  MODIFY `id_proc` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador de la prduccion', AUTO_INCREMENT=72;
...
--
ALTER TABLE `recetas`
  MODIFY `id_rec` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT de la tabla `receta_insumos`
--
ALTER TABLE `receta_insumos`
  MODIFY `id_rec_ins` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
...
--
ALTER TABLE `ventas`
  MODIFY `id_ven` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificacion de la venta', AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT de la tabla `venta_produccion`
--
ALTER TABLE `venta_produccion`
  MODIFY `id_ven_prod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `venta_recetas`
--
ALTER TABLE `venta_recetas`
  MODIFY `id_venta_receta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
