...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-11-2025 a las 02:43:05
...
(13, 'spartacus', '313131', '1231231321', 'spartacus123@gmail.com'),
...
(2, 3, 16.00, '2025-11-05 00:00:00', '2025-11-02', 'Activo'),
...
(20, 53, 10.00, '2025-11-06 14:19:17', '2025-11-30', 'Activo'),
...
(24, 53, 2.00, '2025-11-06 20:27:13', '2025-11-08', 'Activo');
...
(53, 'Baguet', 'g', 10.00, 10.00, 'Activo'),
...
(119, 'Finalizada', 'Marlon', '2025-11-06 13:47:37', '2025-11-06 13:48:04', '2025-11-06 13:48:06'),
(120, 'Finalizada', 'Sebastián', '2025-11-06 13:50:52', '2025-11-06 13:51:00', '2025-11-06 13:51:01'),
(121, 'Finalizada', 'Sebastián', '2025-11-06 14:21:16', '2025-11-06 14:21:30', '2025-11-06 14:21:31'),
(122, 'Finalizada', 'Marlon', '2025-11-06 14:32:03', '2025-11-06 14:32:58', '2025-11-06 14:33:07'),
(123, 'Finalizada', 'Marlon', '2025-11-06 16:18:45', '2025-11-06 16:19:08', '2025-11-06 16:19:09'),
(124, 'Pendiente', 'Marlon Avila', '2025-11-06 17:17:54', NULL, NULL),
(125, 'Finalizada', 'Marlon Avila', '2025-11-06 17:27:18', '2025-11-06 17:27:33', '2025-11-06 17:27:36'),
(126, 'Finalizada', 'Andrés Lopez', '2025-11-06 20:22:23', '2025-11-06 20:26:13', '2025-11-06 20:26:16'),
(127, 'Finalizada', 'Andrés Lopez', '2025-11-06 20:33:26', '2025-11-06 20:34:01', '2025-11-06 20:34:03'),
(128, 'Finalizada', 'Andrés Lopez', '2025-11-06 20:36:38', '2025-11-06 20:37:24', '2025-11-06 20:37:25');
...
(64, 79, 42, 2, 150.00, 300.00),
(65, 80, 43, 2, 1000.00, 2000.00),
(66, 80, 42, 2, 150.00, 300.00),
(67, 81, 43, 1, 1000.00, 1000.00),
(68, 81, 42, 1, 150.00, 150.00),
(69, 82, 43, 1, 1000.00, 1000.00),
(70, 82, 42, 2, 150.00, 300.00),
(71, 83, 43, 1, 1000.00, 1000.00),
(72, 83, 42, 2, 150.00, 300.00),
(73, 84, 43, 1, 1000.00, 1000.00),
(74, 84, 42, 2, 150.00, 300.00),
(75, 85, 43, 1, 1000.00, 1000.00),
(76, 85, 42, 2, 150.00, 300.00),
...
--
ALTER TABLE `pago`
  MODIFY `id_pago` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT de la tabla `produccion`
--
ALTER TABLE `produccion`
  MODIFY `id_proc` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador de la prduccion', AUTO_INCREMENT=129;
...
--
ALTER TABLE `ventas`
  MODIFY `id_ven` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificacion de la venta', AUTO_INCREMENT=96;

--
-- AUTO_INCREMENT de la tabla `venta_produccion`
--
ALTER TABLE `venta_produccion`
  MODIFY `id_ven_prod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT de la tabla `venta_recetas`
--
ALTER TABLE `venta_recetas`
  MODIFY `id_venta_receta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;
