...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-10-2025 a las 05:22:41
...
(3, 'Azúcar', 40.00, 'kg', 25.00, 30.00, '2025-10-31', 'Activo'),
(4, 'Sal', 50.00, 'kg', 10.00, 0.00, NULL, 'Stock insuficiente'),
...
(44, 'Huevo', NULL, 'unidad', 10.00, 1.00, '2025-10-24', 'Stock insuficiente'),
(45, 'Panela', NULL, 'g', 10.00, 40.00, '2025-10-31', 'Activo'),
(46, 'Cardamomo', NULL, 'g', 5.00, 10.00, '2025-10-31', 'Activo'),
...
INSERT INTO `produccion` (`id_proc`, `estado`, `usuario`, `fecha_hora`) VALUES
(74, 'Finalizada', 'Marlon Avila', '2025-10-15 12:00:11'),
(75, 'Pendiente', 'Sebastián Mercado', '2025-10-15 14:04:38'),
(76, 'Completada', 'Marlon Avila', '2025-10-16 17:49:31'),
(77, 'Finalizada', 'Marlon Avila', '2025-10-16 18:25:27'),
(78, 'Finalizada', 'Sebastián Mercado', '2025-10-16 18:49:46'),
(79, 'Finalizada', 'Sebastián Mercado', '2025-10-16 19:42:28'),
(81, 'Finalizada', 'Marlon Avila', '2025-10-16 20:06:25'),
(82, 'Finalizada', 'Paula García', '2025-10-16 20:17:57'),
(84, 'Finalizada', 'Marlon Avila', '2025-10-16 20:27:01'),
(85, 'Finalizada', 'Ana Pérez', '2025-10-16 21:07:07'),
(86, 'Finalizada', 'Marlon Avila', '2025-10-18 17:45:31'),
(87, 'Finalizada', 'Sebastián Mercado', '2025-10-18 17:52:23'),
(88, 'Pendiente', 'Ana Pérez', '2025-10-20 19:10:14'),
(89, 'Finalizada', 'Marlon Avila', '2025-10-20 20:58:41'),
(90, 'Pendiente', 'Marlon Avila', '2025-10-20 20:59:40'),
(91, 'Pendiente', 'Marlon Avila', '2025-10-20 20:59:41'),
(92, 'Finalizada', 'Marlon Avila', '2025-10-20 21:00:07'),
(93, 'Finalizada', 'Sebastián Mercado', '2025-10-20 21:13:36'),
(94, 'Finalizada', 'Luis Rodríguez', '2025-10-20 21:25:51'),
(95, 'Pendiente', 'Marlon Avila', '2025-10-20 21:28:05'),
(96, 'Finalizada', 'Marlon Avila', '2025-10-20 22:17:30'),
(97, 'Pendiente', 'Marlon Avila', '2025-10-20 22:18:16');
...
(34, 'Empanada de cardamomo', 'Wena', 2000.00, 'Activo'),
...
--
ALTER TABLE `pedidos`
  MODIFY `id_ped` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT de la tabla `produccion`
--
ALTER TABLE `produccion`
  MODIFY `id_proc` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador de la prduccion', AUTO_INCREMENT=98;
...
--
ALTER TABLE `recetas`
  MODIFY `id_rec` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT de la tabla `receta_insumos`
--
ALTER TABLE `receta_insumos`
  MODIFY `id_rec_ins` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
...
--
ALTER TABLE `ventas`
  MODIFY `id_ven` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificacion de la venta', AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT de la tabla `venta_produccion`
--
ALTER TABLE `venta_produccion`
  MODIFY `id_ven_prod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT de la tabla `venta_recetas`
--
ALTER TABLE `venta_recetas`
  MODIFY `id_venta_receta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
