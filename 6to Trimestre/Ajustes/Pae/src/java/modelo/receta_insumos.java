...
public class receta_insumos implements Serializable {
    ...
    // 🔹 Nuevos atributos para asociar objetos completos
    ...
    public int getId_rec_ins() { return id_rec_ins; }
    public void setId_rec_ins(int id_rec_ins) { this.id_rec_ins = id_rec_ins; }

    public int getId_rec() { return id_rec; }
    public void setId_rec(int id_rec) { this.id_rec = id_rec; }

    public Integer getId_ins() { return id_ins; }
    public void setId_ins(Integer id_ins) { this.id_ins = id_ins; }
