...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-11-2025 a las 19:58:33
...
(49, 'Espaguetti', 'g', 50.00, 98.00, '2025-11-05', 'Insumo vencido'),
...
--
ALTER TABLE `ventas`
  MODIFY `id_ven` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificacion de la venta', AUTO_INCREMENT=86;
...
--
ALTER TABLE `venta_recetas`
  MODIFY `id_venta_receta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
