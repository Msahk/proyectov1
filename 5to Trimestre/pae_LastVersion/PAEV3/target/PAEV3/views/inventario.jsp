...
<div class="container">
    ...
    <div class="actions-bar">
        ...
        <div style="display: flex; gap: 1rem;">
            ...
            <a href="${pageContext.request.contextPath}/views/entradas.jsp" class="btn btn-info">📥 Detalles Entradas</a>
            <a href="${pageContext.request.contextPath}/views/salidas.jsp" class="btn btn-warning">📤 Detalles Salidas</a>
        </div>
    </div>
